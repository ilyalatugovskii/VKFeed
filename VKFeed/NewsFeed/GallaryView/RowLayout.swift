...
class RowLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        guard var rowHeight = RowLayout.rowHeightCounter(superWitdth: collectionView.frame.width, photosArray: photos) else { return }
        ...
        for item in 0 ..< collectionView.numberOfItems(inSection: 0) {
            ...
            let ration = photosRation[indexPath.row]
    ...
    static func rowHeightCounter(superWitdth: CGFloat, photosArray: [CGSize]) -> CGFloat? {
        ...
        let difference = superWitdth / myPhotoWithMinRation.width
